...
# Optional
ENVIRONMENT=dev
CUSTOM_DOMAIN=leaderboard.yourdomain.com
CERTIFICATE_ARN=arn:aws:acm:us-east-1:123456789012:certificate/your-cert-id
PARTICIPANT_ACCOUNT_IDS=123456789012,210987654321
```

**Note**: S3 bucket names are automatically generated by CDK with the pattern:
